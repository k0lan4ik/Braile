...
class PrinterController :
    ...
    def braillePrint(self, mystring):
        ...
        for letter in mystring:
            if(letter.isupper()):
                print ("letter : " + letter)
                digits = [0,4]        #Transform letters into numbers for the encoder
                self.braillePrinter.emboss(digits)					#Routine for embossing 
                print(digits)
                digits = self.braillePrinter.letters(letter.lower())	        #Transform letters into numbers for the encoder
                self.braillePrinter.emboss(digits)					#Routine for embossing 
                print(digits)
                self.pipe.send(ProgressMessage())
            elif(letter.isdigit()):
                print ("letter : " + letter)
                digits = [4,7]	        #Transform letters into numbers for the encoder
                self.braillePrinter.emboss(digits)					#Routine for embossing 
                print(digits)
